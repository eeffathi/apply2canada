...
* Price color on listing shows now according to the settings

= 2.9.15 - 14/01/2020 =

* Multiple eCommerce Product Catalog performance improvements

= 2.9.14 - 28/11/2019 =

* Wider attributes table on modern listing without price

= 2.9.13 - 20/11/2019 =

* Multiple eCommerce Product Catalog performance improvements
* Price filter reset button added
...
* Empty product category page content fixed

= 2.9.10 - 16/10/2019 =

* New block to display main catalog page content
* New block to display product categories
* Ability to select product subcategories in show products block

= 2.9.9 - 10/10/2019 =

* eCommerce product catalog translation update

= 2.9.8 - 02/10/2019 =

* Product image uploader usability improvements
* eCommerce Product Catalog error reporting improved
...
* eCommerce Product Catalog activation error fix

= 2.9.5 - 31/07/2019 =

* eCommerce structured data template fix

= 2.9.4 - 31/07/2019 =

* eCommerce structured data feature improvements
* Product catalog theme integration improvements in simple mode

= 2.9.3 - 18/07/2019 =

* The product structured data is now optional
* eCommerce Structured data is fully customizable with the template file from templates/template-parts/product-page/structured-data.php
...
* Simple mode integration improvement to support more themes

= 2.9.0 - 13/05/2019 =

* eCommerce Product Catalog now has support for category pages in theme simple mode
* eCommerce icons in main menu or on the top of the screen on mobile - icons for catalog and search - the icons are optional and customizable - eCommerce icons can be enabled in Catalog Settings > Catalog Design > Design Schemes or inside theme customizer
